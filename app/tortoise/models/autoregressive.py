...
class GPT2InferenceModel(GPT2PreTrainedModel):
    ...
    def parallelize(self, device_map=None):
        self.device_map = (
            get_device_map(len(self.transformer.h), range(torch.cpu.device_count()))
    ...
    def forward(
        ...
        if self.model_parallel:
            torch.cpu.set_device(self.transformer.first_device)
    ...
    def inference_speech(
        ...
        **hf_generate_kwargs
        ...
        if not hasattr(self, "inference_model"):
            # Decouple gpt_config from this inference model.
            gpt_config = GPT2Config(
